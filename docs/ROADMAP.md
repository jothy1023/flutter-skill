...
## Phase 1: Multi-Framework Support (v0.7.4)
...
## Phase 2: IDE Panel Integration (v0.7.5)
...
## Phase 3: `.test.md` Engine + MCP Tools (v0.7.6)
...
## Phase 4: Smart Screenshots + Intelligent Waits (v0.7.7)
...
## Phase 5: Error Recovery + Semantic Discovery (v0.7.8)
...
## Phase 6: AI Test Generation + Parallel Execution (v0.7.9)
...
## Phase 7: Live Recording + Streaming (v0.7.10)
...
## Phase 8: Advanced Testing (v0.7.11)
...
| **v0.7.5** | IDE Panels | VSCode test explorer, IntelliJ tool window, `.test.md` format |
| **v0.7.6** | Test Engine | `run_test_plan` MCP tool, `.test.md` parser, CI/CD runner |
| **v0.7.7** | Smart Core | Smart screenshots, intelligent waits |
| **v0.7.8** | Reliability | Error recovery, semantic element discovery |
| **v0.7.9** | AI QA | AI test generation, parallel multi-device execution |
| **v0.7.10** | Recording | Live test recording, MCP streaming progress |
| **v0.7.11** | Advanced Testing | Visual regression, performance monitoring, accessibility |
...
|---------|--------|--------|----------|
| Multi-framework support | High (market) | High | P0 — next |
| IDE panel integration | High (DX) | Medium | P0 |
